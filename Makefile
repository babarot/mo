...
install: build
	install mo $(shell go env GOPATH)/bin/mo
...
.PHONY: default ci generate test build install dev screenshot lint fmt fmt-check depsdev credits prerelease_for_tagpr
